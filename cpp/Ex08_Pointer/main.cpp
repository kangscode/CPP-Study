...
int main()
{
    ...
    *b = 567;
    ...
    cout << sizeof(int *) << " " << sizeof(double *) << endl; // 포인터변수 크기 같음
    ...
    cout << size_t(b) << " " << size_t(b + 1) << " " << size_t(b + 2) << endl; //주소값 4바이트 단위 차이
    cout << size_t(c) << " " << size_t(c + 1) << " " << size_t(c + 2) << endl; //주소값 8바이트 단위 차이
